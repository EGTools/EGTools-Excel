...
<ul>
   ...
   <li> 행끼리 병합 : (v3.4)선택된 영역에 대해서 행별로 '내용 병합'을 한 번에 수행함</li>
   ...
   <br>
   <li> 연간 달력 만들기 : (v3.4)지정하는 연도의 연간 달력 시트를 삽입 (공휴일 표시)</li>
   <li> 월간 일정표 만들기 : (v3.4)지정하는 월의 월간 일정표 시트를 삽입(공휴일, 음력 표시)</li>
   <li> 주간 일정표 만들기 : (v3.4)지정하는 날짜가 포함된 주간 일정표 시트를 삽입(공휴일, 음력, 주요행사, 시간일정 표시)</li>
   <li> 일일 일정표 만들기 : (v3.4)지정하는 날짜의 일일 일정표 시트를 삽입(공휴일, 음력, 주요 업무, 시간일정, 업무메모 표시)</li>
   <br>
   <li> 다단계 선태 기준 : (v3.4)다단계 유효성 검사의 목록(Dropdown List)을 생성</li>
   <li> 다단계 선태 적용 : (v3.4)선택한 셀에 다단계 유효성 검사를 적용</li>
   <li> 다단계 선태 삭제 : (v3.4)필요없는 다단계 유효성 검사를 삭제</li>
   <br>
