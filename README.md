...
## EG Tools 전용 UDF
<ul>
   <li>KoreanHolidays : (v3.4)지정하는 연도의 대한민국 공휴일 목록을 출력 </li>
   <li>AggregateC : (v3.4)감춰신 셀을 제외하는 옵션이 있는 AGGREGATE 확장 함수 </li>
   <li>DisplayColor : (v3.4)대상 셀의 조건부 서식을 포함하여 실제로 표시된 바탕색/글자색의 번호 (검정=0 ~ 흰색=16777215) </li>
   <li>CountIfColor : (v3.4)대상 범위에서 지정하는 바탕색/글자색과 같은 것을 세는 함수(조건부 서식 포함) </li>
   <li>SumIfColor : (v3.4)대상 범위에서 지정하는 바탕색/글자색과 상응하는 값을 합산하는 함수(조건부 서식 포함) </li>
